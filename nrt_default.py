#!/usr/bin/env python3
"""
nrt_default.py - Modified version of nrt.py that runs in the default namespace.
This script configures OSPF adjacency dynamically, loopback interfaces, and runs
...
Usage: 
  sudo ./nrt_default.py [--debug] [--config CONFIG_FILE]
